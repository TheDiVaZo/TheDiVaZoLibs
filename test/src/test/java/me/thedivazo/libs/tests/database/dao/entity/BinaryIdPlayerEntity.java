 ...
 */
public record BinaryIdPlayerEntity(byte[] uuidBytes, String name) {
    ...
    public static BinaryIdPlayerEntity generate() {
        UUID uuid = UUID.randomUUID();
        ByteBuffer byteBuffer = ByteBuffer.wrap(new byte[16]);
        byteBuffer.putLong(uuid.getMostSignificantBits());
        byteBuffer.putLong(uuid.getLeastSignificantBits());
        return new BinaryIdPlayerEntity(byteBuffer.array(), getRandomName());
    }
    ...
    public boolean equals(Object object) {
        ...
        BinaryIdPlayerEntity player = (BinaryIdPlayerEntity) object;
